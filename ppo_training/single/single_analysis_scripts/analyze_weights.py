...
def analyze_synaptic_attention(results_folder: str,
    ...
    for update in updates:
        filepath = fr"{RESULTS_PATH}\{results_folder}\checkpoints\brain_update_{update:03d}.pth"
...
if __name__ == "__main__":
    ...
    analyze_synaptic_attention(results_folder=results_folder)
