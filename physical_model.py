...
class PhysicalModel:
    ...
    gamma: float = 1e-1  # [F]/[v] = [kg/sec] linear drag air resistence (dominant in low speeds)
    c_drag: float = 1e-2  # [F]/[v^2] quadratic drag air resistence (dominant in high speeds)
    ...
    energy_conversion_factors = {
        ...
        'rest': 0.0005,  # constant for Basal Metabolic Rate (BMR) energy
